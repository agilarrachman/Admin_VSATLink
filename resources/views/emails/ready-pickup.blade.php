    ...
    <tr>
        <td style="padding:30px; color:#333333; font-family:Arial, sans-serif;">
            ...
            <p style="font-size:14px; line-height:1.6;">
                Silakan melakukan pengambilan perangkat sesuai dengan ketentuan yang telah ditentukan. Jika Anda
                membutuhkan bantuan atau informasi lebih lanjut, silakan hubungi tim sales kami.
            </p>
