    ...
    <tr>
        <td style="padding:30px; color:#333333;">
            <p style="margin-top:0; font-size:15px;">
                Yth. <strong>Tim Provisioning</strong>,
            </p>

            <p style="font-size:15px; line-height:1.6;"> Kami informasikan bahwa proses <strong>instalasi dan aktivasi
                    layanan</strong> untuk pesanan berikut telah selesai dilakukan di lokasi customer oleh Tim
                Instalasi.
            </p>

            <p style="font-size:15px; line-height:1.6;"> Mohon segera melakukan <strong>verifikasi status
                    layanan</strong> untuk memastikan layanan telah aktif dan berjalan dengan normal. </p>
            ...
            <p style="font-size:14px; line-height:1.6;"> Silakan melakukan pengecekan dan konfirmasi aktivasi layanan
                sesuai prosedur operasional yang berlaku. </p>
