            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="mb-3 col-md-6">
                        ...
                        <input class="form-control" type="text" id="sales_name" name="sales_name" readonly />
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="sales_phone" class="form-label">Nomor Telepon Sales Pendamping</label>
                        <input class="form-control" type="text" id="sales_phone" name="sales_phone" readonly />
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="sales_email" class="form-label">Email Sales Pendamping</label>
                        <input class="form-control" type="text" id="sales_email" name="sales_email" readonly />
                    </div>
                    <div class="mb-3 col-md-6">
